...
function About() {
    ...
    <section className="title">
      <h2 class="name">Steven Francius</h2>
      <hr></hr>
      
      <div className="row justify-content-center">
        <div className="col-10" id="about-section">
            <img class="mb-5" id="avatar" src="https://avatars3.githubusercontent.com/u/48327492?s=460&u=a11266d609efcab0dbdf0e4a735cabeba870f34c&v=4" alt="Jake Kelly"/>
        
        <p>Core competencies in web technology product ownership, full-stack web development, health information systems, data architecture, and managing integrations.</p>
        <p>
